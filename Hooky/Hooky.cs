...
namespace Hooky
{
	...
	public class HookyMain : System.Windows.Forms.Form
	{
		...
		private SerialPorts.SerialPort commPort;
		private SerialPorts.WithEvents commEvents;
		...
		public HookyMain()
		{
			...
			SerialPorts.SerialCnfg commConfig = new SerialCnfg(0);
			commConfig.BaudRate = SerialPorts.LineSpeed.Baud_38400;
			commConfig.DataBits = SerialPorts.ByteSize.Eight;
			commConfig.StopBits = SerialPorts.StopBits.One;
			commConfig.Parity = SerialPorts.Parity.None;

			commEvents = new SerialPorts.WithEvents();
			commEvents.RxChar  = new ByteFunc(this.OnRecvI);


			commPort = new SerialPort(commEvents);
			commPort.Open(0);
		}
		...
		private void InitializeComponent()
		{
			...
			// threadDetectLabel
			// 
			this.threadDetectLabel.Location = new System.Drawing.Point(8, 56);
			...
			this.threadRescanButton.Location = new System.Drawing.Point(208, 56);
			...
			this.threadHookBox.Location = new System.Drawing.Point(352, 56);
			...
			// quitButton
			// 
			this.quitButton.Location = new System.Drawing.Point(376, 112);
